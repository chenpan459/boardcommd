...
//
// Vendored from https://github.com/skywind3000/kcp (ikcp.h)
//
//=====================================================================
#ifndef _IKCP_H_
#define _IKCP_H_
...
struct IKCPOPS {
    ...
    void (*on_pkt_sent)(ikcpcb *kcp, IUINT32 sn, IUINT32 ts, IUINT32 len, IUINT32 inflight, IUINT32 xmit);
    void (*on_pkt_acked)(ikcpcb *kcp, IUINT32 sn, IUINT32 ts, IUINT32 len, IINT32 rtt, IUINT32 xmit);
